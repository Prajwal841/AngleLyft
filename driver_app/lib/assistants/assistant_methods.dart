...
class AssistantMethods
{
  ...
  static double calculateFareAmountFromOriginToDestination(DirectionDetailsInfo directionDetailsInfo)
  {
    ...
    double tempFareAmount=timeTraveledFareAmountPerMinute + distanceTraveledFareAmountPerKilometer;
    double totalFareAmount = tempFareAmount*82 ;


    if(driverVehicleType == "bike")
    {
      double resultFareAmount = (totalFareAmount.truncate().toDouble()) / 2.0;
      return resultFareAmount;
    }
    else if(driverVehicleType == "Rikshaw")
    {
      return (totalFareAmount.truncate().toDouble())*0.85;
    }
